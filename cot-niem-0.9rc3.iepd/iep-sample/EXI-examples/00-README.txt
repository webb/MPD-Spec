...
Alas, our EXI serialization tools do not yet have built-in support for
XML Catalog resolution.  This support could be added, but it's more Java
programming than we felt like doing.  So, in order to obtain the EXI test 
results in this directory, we had to adopt a work-around:
